...
# redis_data 172.18.0.2 = redis.Redis.from_url('rediss://red-ces58ckgqg4dp7osntrg:IoErEp3b89kSifhHQZuRrZ7sKloq0r9M@oregon-redis.render.com:6379')
redis_data = redis.Redis(host='redis', port=6379, db=0)
